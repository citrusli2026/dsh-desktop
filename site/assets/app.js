...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      'hero.sub': 'dsh-electron-shell 是 DeepSeek Harness 的 Electron 桌面壳:自带 Node.js 运行时与完整依赖,双击即用;独立数据目录,与命令行互不影响。',
      'hero.cta': '下载桌面版',
      ...
      'footer.legal': 'MIT © 2026 dsh-electron-shell contributors<br />非官方社区打包,与 DeepSeek AI 无关联',
    ...
    en: {
      ...
      'hero.sub': 'dsh-electron-shell is the unofficial Electron desktop shell for DeepSeek Harness: bundled Node.js runtime and full dependency closure — download and run. Isolated data home, fully separate from the CLI.',
      ...
      'footer.legal': 'MIT © 2026 dsh-electron-shell contributors<br />Unofficial community packaging, not affiliated with DeepSeek AI',
