...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      'ft.tab1': '零配置', 'ft.tab2': '独立环境', 'ft.tab3': '稳定守护', 'ft.tab4': '自动更新', 'ft.tab5': '安全边界',
    ...
    en: {
      ...
      'ft.tab1': 'Zero setup', 'ft.tab2': 'Isolated home', 'ft.tab3': 'Supervision', 'ft.tab4': 'Auto-update', 'ft.tab5': 'Security boundary',
