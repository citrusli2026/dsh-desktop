/* dsh-desktop 官网脚本 v3 (ESM):
   ...
   零依赖,渐进增强。 */
import { I18N, platformOf, publicKind, splitCompositeTag, fmtSize, fmtNum, fmtDate, normalizeReleasesPayload } from './data-model.js?v=41'
...
function renderMeta(data) {
  ...
  if (split) {
    $all('[data-core-version]').forEach(function (el) { el.textContent = split.core })
    var core = $('#v-core')
    var shell = $('#v-shell')
