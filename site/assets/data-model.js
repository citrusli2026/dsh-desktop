...
export var I18N = {
  zh: {
    ...
    'ft.p7': '<h3>不用找窗口，快捷键直接唤回</h3><p>窗口收进托盘后，在任意应用中按 <code>Ctrl + Shift + Space</code> 即可显示并聚焦 dsh-desktop。快捷键冲突时，托盘和右键入口仍然可用。</p>',
    'theme.toggle': '切换明暗主题',
  ...
  en: {
    ...
    'ft.p7': '<h3>Return without hunting for the window</h3><p>After hiding dsh-desktop to the tray, press <code>Ctrl/Cmd + Shift + Space</code> from any app to show and focus it. The tray and context menu remain available if the shortcut is occupied.</p>',
