...
export var I18N = {
  zh: {
    ...
    'showcase.s3.body': '设置页首屏只保留运行状态、数据目录、局域网配对、快捷键、启动行为和通知；不常用的恢复与资源操作收进“更多扩展工具”。',
    'showcase.s3.items': '<li>首屏看到状态、数据目录和手动插件边界</li><li>配对、快捷键、开机启动、托盘和通知直接可用</li><li>屏幕捕获、Safe Mode、内核和预设进入二级区域</li>',
  ...
  en: {
    ...
    'showcase.s3.body': 'The first view keeps runtime status, local data, LAN pairing, shortcuts, startup behavior, and notifications together. Less frequent recovery and resource actions live under “More shell tools”.',
    'showcase.s3.items': '<li>Status, data directory, and the manual plugin boundary at a glance</li><li>Pairing, shortcut, login, tray, and notification controls up front</li><li>Screen capture, Safe Mode, kernel, and presets behind a secondary section</li>',
