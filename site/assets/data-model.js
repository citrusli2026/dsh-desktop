...
export var I18N = {
  zh: {
    ...
    'wf.s3.title': '出错可恢复', 'wf.s3.body': '安全模式、诊断和回滚，让问题有下一步。',
    ...
    'mk.route2.body': '出现问题时，用安全模式隔离第三方插件。',
    ...
    'faq.a14': '应用仍可打开时，先到「设置 → 桌面设置 → 运行体检」查看本地运行时、目录、loopback、Profile 与插件状态；联网检查需单独勾选，结果不上传也不自动修复。无法启动时，错误页提供「再次启动」「以安全模式启动」「打开日志目录」「导出诊断报告」。安全模式只保留官方与内置扩展，并隔离用户插件，不删除或移动插件文件。',
  ...
  en: {
    ...
    'wf.s3.title': 'Recoverable by design', 'wf.s3.body': 'Safe Mode, diagnostics, and rollback give failures a next step.',
    ...
    'mk.route2.body': 'Safe Mode quarantines third-party plugins if something breaks.',
