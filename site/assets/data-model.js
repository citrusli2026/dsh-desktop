...
export var I18N = {
  zh: {
    ...
    'nav.market': '插件市场',
    'mk.marker': '插件市场', 'mk.title': '数千个社区插件，按需安装',
    ...
    'mk.note': '所有安装都需要用户主动操作：在「设置 → 扩展设置 → 插件市场」点「安装插件市场」，再从插件市场选择其他插件。',
    'theme.toggle': '切换明暗主题',
  ...
  en: {
    ...
    'mk.marker': 'Plugin market', 'mk.title': 'Thousands of community plugins, installed by choice',
    ...
    'mk.note': 'Every community plugin is opt-in: install the market manually from Settings → Extensions → Plugin market, then choose what to add.',
