...
export var I18N = {
  zh: {
    ...
    'latest.marker': '当前版本重点', 'latest.title': '这个版本，更稳也更好上手',
    'latest.lead': '本版本重点：安装、恢复与更新更可靠。',
    'latest.items': '<li><b>首次成功：</b>主界面四步引导在首条任务完成后自动结束。</li><li><b>一键体检：</b>本地检查运行环境、数据目录、本地端口与插件状态。</li><li><b>隐私可控：</b>联网检查需主动勾选，社区插件仍完全可选。</li>',
  ...
  en: {
    ...
    'latest.lead': 'This release focuses on dependable install, recovery, and updates.',
    'latest.items': '<li><b>First success:</b> a four-step main-screen guide retires after the first completed task.</li><li><b>One-click health:</b> inspect the runtime, data folders, local ports, and plugins.</li><li><b>Private by default:</b> network probes are opt-in and community plugins stay optional.</li>',
