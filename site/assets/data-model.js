...
export var I18N = {
  zh: {
    ...
    'hero.downloads': '↓ {n} 次下载 · GitHub 统计',
    ...
    'footer.legal': 'MIT © 2026 dsh-desktop contributors<br /><strong>社区维护</strong><br />与 DeepSeek AI 无隶属、授权或合作关系',
  ...
  en: {
    ...
    'hero.downloads': '↓ {n} downloads · GitHub',
    ...
    'footer.legal': 'MIT © 2026 dsh-desktop contributors<br /><strong>Community-maintained</strong><br />No affiliation, authorization, or partnership with DeepSeek AI',
