...
export var I18N = {
  zh: {
    ...
    'a11y.menuOpen': '打开导航', 'a11y.menuClose': '关闭导航',
      'brand.community': '社区版',
    'nav.workflow': '定位', 'nav.features': '能力', 'nav.version': '版本', 'nav.faq': '支持', 'nav.install': '安装指南', 'nav.cta': '立即下载',
    ...
    'latest.items': '<li><b>状态更清楚：</b>桌面入口、托盘和设置使用同一套 Harness、Safe Mode 与更新状态。</li><li><b>恢复更直接：</b>启动失败可重试、进入 Safe Mode、查看日志或导出本地诊断报告。</li><li><b>插件更克制：</b>安装包不含社区插件；dsh-market 和其他插件都由用户手动选择安装。</li><li><b>更新更安全：</b>内核切换经过健康启动检查，失败时恢复内置版本。</li>',
  ...
  en: {
    ...
    'nav.workflow': 'SCOPE', 'nav.features': 'CAPABILITIES', 'nav.version': 'VERSION', 'nav.faq': 'SUPPORT', 'nav.install': 'INSTALL GUIDE', 'nav.cta': 'Download',
