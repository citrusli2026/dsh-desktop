...
export var I18N = {
  zh: {
    ...
    'nav.market': '插件市场',
    'mk.marker': '插件市场', 'mk.title': '数千个社区插件，一键安装',
    'mk.lead': '通过社区插件市场 dsh-market，在 Harness 设置里浏览并安装社区插件与主题，全程无需命令行。',
    'mk.c1': '<h3>开箱即带</h3><p>新安装的 dsh-desktop 首次启动自动预装插件市场与两个精选扩展（Better Sidebar、任务看板），在官方「设置 → 插件」中管理，升级卸载随意。</p>',
    ...
    'mk.note': '从老版本升级的用户：在「设置 → 扩展设置 → 插件市场」点「安装插件市场」补装即可。',
    'theme.toggle': '切换明暗主题',
  ...
  en: {
    ...
    'mk.marker': 'Plugin market', 'mk.title': 'Thousands of community plugins, one click away',
    'mk.lead': 'Through the community market dsh-market, browse and install community plugins and themes right from Harness settings — no terminal required.',
    'mk.c1': '<h3>Bundled out of the box</h3><p>A fresh dsh-desktop seeds the plugin market plus two curated extensions (Better Sidebar, Task Board) on first launch; manage them in Settings → Plugins, upgrade or remove freely.</p>',
    ...
    'mk.note': 'Upgrading from an older build? Install the market from Settings → Extensions → Plugin market.',
