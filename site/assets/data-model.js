...
export var I18N = {
  zh: {
    ...
    'showcase.s2.title': '桌面偏好与恢复入口',
    'showcase.s2.body': '设置页把桌面习惯和故障路径放在同一个清晰入口：语言、主题、快捷键、启动行为与本地通知都由你决定。',
    'showcase.s2.items': '<li>明色、深色或跟随系统</li><li>快捷键、开机启动、托盘与通知按需开启</li><li>插件市场手动安装，异常时可进安全模式</li>',
    'showcase.s2.caption': '真实截图 · 桌面设置页',
    'showcase.note': '截图来自真实应用构建；官网明暗主题会同步选择对应截图。自动播放仅用于展示，悬停、聚焦或点击暂停后由你控制。',
  ...
  en: {
    ...
    'showcase.s2.title': 'Desktop preferences and recovery entry points',
    'showcase.s2.body': 'The settings surface keeps desktop habits and recovery paths together: language, theme, shortcut, startup behavior, and local notices stay under your control.',
    'showcase.s2.items': '<li>Light, dark, or follow system</li><li>Opt-in shortcut, launch-at-login, tray, and notices</li><li>Manual plugin market install, with Safe Mode when needed</li>',
    'showcase.s2.caption': 'Real capture · desktop settings',
    'showcase.note': 'Captured from real application builds. The site chooses the matching light or dark screenshot; auto-play is only a preview and pauses when you interact.',
