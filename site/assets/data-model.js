...
export var I18N = {
  zh: {
    ...
    'latest.lead': '新增桌面垃圾桶：会话、预设和 Agent 删除的文件，都先进垃圾桶，随时还原。',
    ...
    'faq.a15': '可以。桌面版自带垃圾桶：删除的会话、预设都会先进入垃圾桶，在 <b>「设置 → 垃圾桶」</b> 中随时还原。Agent 执行的删除类命令也会被拦截：目标先移入垃圾桶，可疑的删除会被直接拦截并说明原因。垃圾桶保留 30 天，过期自动清理。',
  ...
  en: {
    ...
    'latest.lead': 'New desktop trash: sessions, presets, and agent-deleted files land in the trash first, ready to restore.',
    ...
    'faq.a15': 'Yes. The desktop trash keeps deleted sessions and presets recoverable from <b>Settings → Trash</b>. Agent deletion commands are intercepted too: targets move into the trash first, and ambiguous deletions are blocked with an explanation. Entries are kept for 30 days, then cleaned up automatically.',
