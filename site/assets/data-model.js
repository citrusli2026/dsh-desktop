...
export var I18N = {
  zh: {
    ...
    'hero.highlightBalance.label': '账户余额', 'hero.highlightBalance.value': '托盘里直接查看', 'hero.highlightBalance.note': '有可用 API Key 时，在托盘与扩展设置中显示。',
  ...
  en: {
    ...
    'hero.highlightBalance.label': 'ACCOUNT', 'hero.highlightBalance.value': 'Balance at a glance', 'hero.highlightBalance.note': 'Shown in the tray and Extensions settings when an API key is available.',
