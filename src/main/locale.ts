...
const english = {
  ...
  'menu.vision': 'Vision (ModLens)',
  'menu.visionSettings': 'Vision Settings…',
  'menu.visionStatus': 'Vision Status',
  'menu.visionInstalled': '{name} v{version}',
  'menu.visionNotInstalled': 'Not installed',
  'vision.description': 'Gives text-only models image understanding capability (OCR, layout analysis, semantic structuring).',
  ...
  'about.visionInstalled': 'Pre-installed: {name} v{version} — {description}',
  'about.visionNotInstalled': '',
...
const chinese: Record<CopyKey, string> = {
  ...
  'menu.vision': '视觉识别 (ModLens)',
  'menu.visionSettings': '视觉设置…',
  'menu.visionStatus': '视觉状态',
  'menu.visionInstalled': '{name} v{version}',
  'menu.visionNotInstalled': '未安装',
  'vision.description': '为纯文本模型提供图片理解能力（OCR、布局分析、语义结构化）',
  'menu.minimize': '最小化',
  ...
  'about.visionInstalled': '预装扩展：{name} v{version} — {description}',
  'about.visionNotInstalled': '',
