...
const english = {
  ...
  'menu.communityWebsite': 'dsh-desktop Website (Community)',
  'menu.projectRepository': 'Project Repository',
  'menu.reportIssue': 'Report an Issue',
  'menu.harnessOfficial': 'DeepSeek Harness — Official',
  ...
  'page.startingStatus': 'LOCAL · STARTING',
  'page.startingTitle': 'Starting your local Harness workspace',
  'page.startingBody': 'The runtime, data directory, and process supervisor are getting ready. The first launch may take a little longer.',
...
const chinese: Record<CopyKey, string> = {
  ...
  'menu.communityWebsite': 'dsh-desktop 官网（社区）',
  'menu.projectRepository': '项目源代码',
  'menu.reportIssue': '反馈问题',
  'menu.harnessOfficial': 'DeepSeek Harness 官方页',
  ...
  'page.startingStatus': '本地 · 正在启动',
  'page.startingTitle': '正在启动本地 Harness 工作区',
  'page.startingBody': '运行时、数据目录与进程守护正在就绪。首次启动可能需要稍多一点时间。',
