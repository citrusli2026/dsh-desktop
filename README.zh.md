...
- **桌面垃圾桶** —— 删除的会话、预设都可在「设置 → 垃圾桶」还原;Agent 的删除命令会先移入垃圾桶,可疑删除直接拦截并说明原因。保留 30 天。
...
版本与 tag 为复合式:`<dsh 版本>.shell.<壳修订号>`——如 `0.1.7-alpha.2.shell.0`
表示打包 `@deepseek-ai/dsh` 0.1.7-alpha.2、壳第 0 次修订。版本字段由
