...
- **开箱即用的插件路径** —— 安装包不预装社区插件；需要时从「设置 → 扩展设置 → 插件市场」手动安装市场，再按需选择其他插件。
...
版本与 tag 为复合式:`<dsh 版本>.shell.<壳修订号>`——如 `0.1.2-alpha.3.shell.0`
表示打包 `@deepseek-ai/dsh` 0.1.2-alpha.3、壳第 0 次修订。版本字段由
